...
const Jobs = () => {
    ...
    const categoryArray = ["Web Development", "App Development", "Mobile Development", "Software Development", " Finance & Accounting"]
                ...
                <section className="lg:px-10 px-5 py-16">
                    <div className="py-8 bg-white w-full flex flex-col gap-5  md:flex-row text-[#161931]">
                        <aside className="hidden py-4 md:w-1/3 lg:w-1/3 md:block">
                            <div className="sticky flex flex-col gap-2 border-r border-indigo-100 top-12" >
                                <div>
